...
const RegisterPageUser = () => {
  ...
  const handleRegisterUser = (values: RegisterUserFormData) => {
          ...
          {({ isSubmitting, touched, errors: formErrors }) => (
            <Form className="mt-8 space-y-6">
              ...
              <div>
                <button
                  type="submit"
                  disabled={registerUserMutation.isPending || isSubmitting}
              ...
              <div className="text-center">
                <p className="text-sm text-gray-600">
                  Want to register as creator?{' '}
                  <a href="/register/creator" className="font-medium text-blue-600 hover:text-blue-500">
                    Click here
                  </a>
                </p>
              </div>
